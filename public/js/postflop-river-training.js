(() => {
    const state = {
        spot: window.ApexPostflopRiverTraining?.initialSpot ?? null,
        summary: window.ApexPostflopRiverTraining?.initialSummary ?? {},
        leaks: window.ApexPostflopRiverTraining?.initialLeaks ?? [],
        currentModule: window.ApexPostflopRiverTraining?.initialModule ?? '',
        locked: false,
    };
