...
<?php $component->withAttributes([]); ?>
    ...
    <script>
        window.ApexPostflopTraining = {
            ...
            nextUrl: <?php echo json_encode(route('postflop-training.next'), 15, 512) ?>,
            answerUrl: <?php echo json_encode(route('postflop-training.answer'), 15, 512) ?>,
            csrf: <?php echo json_encode(csrf_token(), 15, 512) ?>,
            i18n: <?php echo json_encode($postflopI18n, 15, 512) ?>,
        };
    </script>
    ...
    <main class="postflop-page">
        <section class="postflop-header">
            <div>
                <span class="postflop-kicker"><?php echo e(__('postflop.kicker')); ?></span>
                <h1><?php echo e(__('postflop.title')); ?></h1>
                <p><?php echo e(__('postflop.subtitle')); ?></p>
            </div>

            <div class="street-tabs">
                <a href="<?php echo e(route('spot-training.index')); ?>"><?php echo e(__('postflop.tabs.preflop')); ?></a>
                <a href="<?php echo e(route('postflop-training.index')); ?>" class="is-active"><?php echo e(__('postflop.tabs.postflop')); ?></a>
            </div>

            <form method="POST" action="<?php echo e(route('postflop-training.reset')); ?>">
                <?php echo csrf_field(); ?>
                <button type="submit" class="ghost-btn"><?php echo e(__('postflop.reset')); ?></button>
            </form>
        </section>
        ...
        <section class="postflop-layout">
            ...
            <aside class="postflop-panel">
                ...
                <div class="postflop-box summary-box">
                    <h3><?php echo e(__('postflop.session')); ?></h3>
                    ...
                    <div class="leaks-box">
                        <h4><?php echo e(__('postflop.flop_summary')); ?></h4>
    ...
    <script src="<?php echo e(asset('js/postflop-training.js')); ?>"></script>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\apexcash\resources\views/spot-training/postflop.blade.php ENDPATH**/ ?>