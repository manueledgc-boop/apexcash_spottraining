...
<head>
    <meta charset="UTF-8">
    <title><?php echo e($title ?? 'ApexCash'); ?></title>
</head>
                ...
                <tr>
                    <td style="padding:24px 34px; border-top:1px solid #244536; text-align:center; color:#9fb2a8; font-size:13px;">
                        ...
                        <div style="color:#6f8177;">
                            © <?php echo e(date('Y')); ?> ApexCash · apexcashtrainer.com
                        </div>
                    </td>
                </tr>
...
</html><?php /**PATH C:\laragon\www\apexcash\resources\views/emails/layout.blade.php ENDPATH**/ ?>