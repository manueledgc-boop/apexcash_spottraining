...
<?php $component->withAttributes([]); ?>
    <div class="auth-form-header">
        <span><?php echo e(__('auth.register.badge')); ?></span>
        <h2><?php echo e(__('auth.register.title')); ?></h2>
        <p><?php echo e(__('auth.register.subtitle')); ?></p>
    </div>

    <div class="auth-benefits">
        <div>
            <strong><?php echo e(__('auth.register.benefits.xp.title')); ?></strong>
            <span><?php echo e(__('auth.register.benefits.xp.text')); ?></span>
        </div>

        <div>
            <strong><?php echo e(__('auth.register.benefits.leaks.title')); ?></strong>
            <span><?php echo e(__('auth.register.benefits.leaks.text')); ?></span>
        </div>

        <div>
            <strong><?php echo e(__('auth.register.benefits.spots.title')); ?></strong>
            <span><?php echo e(__('auth.register.benefits.spots.text')); ?></span>
        </div>
    </div>

    <div class="auth-social">
        <a href="<?php echo e(route('google.redirect')); ?>" class="auth-google-btn">
            ...
            <span><?php echo e(__('auth.google.continue')); ?></span>
        </a>

        <div class="auth-divider">
            <span><?php echo e(__('auth.google.or_email')); ?></span>
        </div>
    </div>
    ...
    <form method="POST" action="<?php echo e(route('register')); ?>" class="auth-form">
        ...
        <div class="auth-field">
            <label for="name"><?php echo e(__('auth.fields.name')); ?></label>
            <input
                id="name"
                type="text"
                name="name"
                ...
                required
                autocomplete="name"
                placeholder="<?php echo e(__('auth.placeholders.name')); ?>"
            >
...
<?php endif; ?>
        ...
        <div class="auth-field">
            ...
            <input
                ...
                placeholder="<?php echo e(__('auth.placeholders.new_password')); ?>"
            >
            <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
        ...
        <div class="auth-field">
            <label for="password_confirmation"><?php echo e(__('auth.fields.password_confirmation')); ?></label>
            <input
                ...
                required
                autocomplete="new-password"
                placeholder="<?php echo e(__('auth.placeholders.password_confirmation')); ?>"
            >
            <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
        ...
        <div class="auth-switch">
            <span><?php echo e(__('auth.register.already_registered')); ?></span>
            <a href="<?php echo e(route('login')); ?>"><?php echo e(__('auth.register.login')); ?></a>
        </div>
    </form>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\apexcash\resources\views/auth/register.blade.php ENDPATH**/ ?>