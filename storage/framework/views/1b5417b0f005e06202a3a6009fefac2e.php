...
<?php $component->withAttributes([]); ?>
    ...
    <script>
        window.ApexSpotTraining = {
            ...
            freeLimitReached: <?php echo json_encode($freeLimitReached ?? false, 15, 512) ?>,
            freeLimitMessage: <?php echo json_encode($freeLimitMessage ?? null, 15, 512) ?>,
        };
    </script>
            ...
            <aside class="spot-panel">
                ...
                <div class="spot-box summary-box">
                    ...
                    <div class="summary-grid">
                        <div><span><?php echo e(__('preflop.summary.total')); ?></span><strong id="summaryTotal">0</strong></div>
