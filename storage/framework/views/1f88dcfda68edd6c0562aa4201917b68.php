...
<?php $component->withAttributes([]); ?>
    <div class="auth-form-header">
        <span><?php echo e(__('auth.login.badge')); ?></span>
        <h2><?php echo e(__('auth.login.title')); ?></h2>
        <p><?php echo e(__('auth.login.subtitle')); ?></p>
    </div>

    <?php if (isset($component)) { $__componentOriginal7c1bf3a9346f208f66ee83b06b607fb5 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal7c1bf3a9346f208f66ee83b06b607fb5 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.auth-session-status','data' => ['class' => 'auth-status','status' => session('status')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'auth-status','status' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(session('status'))]); ?>
...
<?php endif; ?>
    ...
    <form method="POST" action="<?php echo e(route('login')); ?>" class="auth-form">
        ...
        <div class="auth-field">
            <label for="email"><?php echo e(__('auth.fields.email')); ?></label>
            <input
                id="email"
                type="email"
                name="email"
                ...
                placeholder="<?php echo e(__('auth.placeholders.email')); ?>"
            >
...
<?php endif; ?>
        ...
        <div class="auth-field">
            <label for="password"><?php echo e(__('auth.fields.password')); ?></label>
            <input
                id="password"
                type="password"
                name="password"
                ...
                placeholder="<?php echo e(__('auth.placeholders.password')); ?>"
            >
            <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
        ...
        <div class="auth-options-row">
            <label for="remember_me" class="auth-check">
                ...
                <span><?php echo e(__('auth.login.remember')); ?></span>
            </label>
        ...
        <div class="auth-switch">
            <span><?php echo e(__('auth.login.no_account')); ?></span>
            <a href="<?php echo e(route('register')); ?>"><?php echo e(__('auth.login.create_account')); ?></a>
        </div>
    </form>
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\apexcash\resources\views/auth/login.blade.php ENDPATH**/ ?>