...
class TurnProbeSpots
{
    ...
    protected static function avoidProbeCompletedFlushBadCard(): array
    {
        return self::spot(
            ...
            'turn_probe',
            'Turn Probe Bet',
            'avoid_probe_completed_flush_no_blocker',
    ...
    protected static function avoidProbeWeakDrawDominated(): array
    {
        return self::spot(
            ...
            'turn_probe',
            'Turn Probe Bet',
            'avoid_probe_weak_draw_dominated',
    ...
    protected static function avoidProbeIntoStrongCheckingRange(): array
    {
        return self::spot(
            ...
            'turn_probe',
            'Turn Probe Bet',
            'avoid_probe_strong_checkback_range',
