...
class ThreeBetVsOpenSpots
{
    ...
    protected static function spots(): array
    {
        return [
            ...
            self::spot('BTN', 'UTG', ['Ac','Jd'], 'CALL', [28,58,14], 'AJo contra UTG no es 3Bet automática. En posición puede defender pagando; foldear contra nits no es horrible.', 'suited_broadway', 'Broadways suited'),
